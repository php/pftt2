 ...
 */
public abstract class CharsetRecog_2022 extends CharsetRecognizer {

	public abstract byte[][] getEscapeSequences();
    ...
    @Override
    public void match(byte [] text, int textLen, CharsetRec cr) {
    	byte [][] escapeSequences = this.getEscapeSequences(); 
        int     i, j;
        int     escN;
        int     hits   = 0;
        int     misses = 0;
    ...
    public static class CharsetRecog_2022JP extends CharsetRecog_2022 {
        ...
        @Override
        public byte[][] getEscapeSequences() {
