...
//                }
    ...
    abstract byte[] getByteMap();
    abstract int[] getNGramList();
    ...
    public void match(byte[] input, int len, CharsetRec cr) {
    	int b;
        boolean ignoreSpace = false;
        byte spaceChar = 0x20; // TODO
        int byteIndex = 0;
        byte[] byteMap = getByteMap();
        int[] ngramList = getNGramList();
...
//                    private void addByte(int b)
//                    {
                        ngram = ((ngram << 8) + (mb & 0xFF)) & N_GRAM_MASK;
//                        lookup(ngram);
//                        private void lookup(int thisNgram)
//                        {
                            ngramCount += 1;
                            
                            if (NGramParser.search(ngramList, ngram) >= 0) {
                                hitCount += 1;
                            }
...
//        private void addByte(int b)
//        {
            ngram = ((ngram << 8) + (spaceChar & 0xFF)) & N_GRAM_MASK;
//            lookup(ngram);
//        }
//        private void lookup(int thisNgram)
//        {
...
//            }
        ...
        cr.confidence = (int) (rawPercent * 300.0);        
    }
    
    protected abstract Charset getCharset(boolean haveC1Bytes);
    ...
    abstract static class CharsetRecog_8859_1 extends CharsetRecog_sbcs
    {
        ...
        {
        	// go with a real standard
            return "ISO-8859-1";
        }
        
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return haveC1Bytes ? CharsetRec.WINDOWS_1252 : CharsetRec.ISO_8859_1;
        }
    }

    public static class CharsetRecog_8859_1_da extends CharsetRecog_8859_1
    {
		...
		public ERecognizedLanguage getLang() {
			return ERecognizedLanguage.DA;
		}
    }

    public static class CharsetRecog_8859_1_de extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_en extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_es extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_fr extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_it extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_nl extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_no extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_pt extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_1_sv extends CharsetRecog_8859_1
    {
        private static int[] ngrams = {
    ...
    public abstract static class CharsetRecog_8859_2 extends CharsetRecog_sbcs
    {
        protected static byte[] byteMap = {
            (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, 
            (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, (byte) 0x20, 
        ...
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return haveC1Bytes ? CharsetRec.WINDOWS_1250 : CharsetRec.ISO_8859_2;
        }
    }
    
    public static class CharsetRecog_8859_2_cs extends CharsetRecog_8859_2
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_2_hu extends CharsetRecog_8859_2
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_2_pl extends CharsetRecog_8859_2
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_2_ro extends CharsetRecog_8859_2
    {
        private static int[] ngrams = {
    ...
    public static class CharsetRecog_8859_6_ar extends CharsetRecog_8859_6
    {
        ...
        @Override
		public ERecognizedLanguage getLang() {
        	// ISO-8859-6 is supposed to be in 'visual order'
        	return ERecognizedLanguage.AR_RIGHT_TO_LEFT;
        }
        public int match(CharsetDetector det)
        {
            return match(det, ngrams, byteMap);
    ...
    abstract static class CharsetRecog_8859_7 extends CharsetRecog_sbcs
    {
        ...
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return haveC1Bytes ? CharsetRec.WINDOWS_1253 : CharsetRec.ISO_8859_7;
        }
    }
    ...
    abstract static class CharsetRecog_8859_8 extends CharsetRecog_sbcs
    {
        ...
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return haveC1Bytes ? CharsetRec.WINDOWS_1255 : CharsetRec.ISO_8859_8;
        }
    }
    ...
    public static class CharsetRecog_8859_8_I_he extends CharsetRecog_8859_8
    {
        ...
        @Override
		public ERecognizedLanguage getLang() {
        	return ERecognizedLanguage.HE_LEFT_TO_RIGHT;
        }
        public int match(CharsetDetector det)
        {
            return match(det, ngrams, byteMap);
    ...
    abstract static class CharsetRecog_8859_9 extends CharsetRecog_sbcs
    {
        ...
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return haveC1Bytes ? CharsetRec.WINDOWS_1254 : CharsetRec.ISO_8859_9;
        }
    }
    ...
    public static class CharsetRecog_windows_1251 extends CharsetRecog_sbcs
    {
        ...
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return CharsetRec.WINDOWS_1251;
        }
        public String getLanguage()
        {
            return "ru";
    ...
    public static class CharsetRecog_windows_1256 extends CharsetRecog_sbcs
    {
        ...
        @Override
        protected Charset getCharset(boolean haveC1Bytes) {
        	return CharsetRec.WINDOWS_1256;
        }
        public String getLanguage()
        {
            return "ar";
        ...
        @Override
		public ERecognizedLanguage getLang() {
        	// Windows-1256 allows intermixing with french text so it would need to be left to right
        	return ERecognizedLanguage.AR_LEFT_TO_RIGHT;
        }
        public int match(CharsetDetector det)
        {
            return match(det, ngrams, byteMap);
...
/* F- */    (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, (byte) 0x40, 
    ...
    public static class CharsetRecog_IBM424_he_rtl extends CharsetRecog_IBM424_he 
    {
        ...
        @Override
		public ERecognizedLanguage getLang() {
			return ERecognizedLanguage.HE_RIGHT_TO_LEFT;
		}
        private static int[] ngrams = {
