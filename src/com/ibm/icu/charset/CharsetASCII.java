...
class CharsetASCII extends CharsetICU {
    ...
    class CharsetDecoderASCII extends CharsetDecoderICU {
        ...
        protected CoderResult decodeLoop(ByteBuffer source, CharBuffer target, IntBuffer offsets,
            ...
            if (source.hasArray() && target.hasArray() && cdl == null) {
                /* optimized loop */
                ...
                /* unoptimized loop */
                cr = decodeLoopCoreUnoptimized(source, target, cdl);
        ...
        protected CoderResult decodeLoopCoreUnoptimized(ByteBuffer source, CharBuffer target, CharsetDecoderListener cdl) {
            int ch = 0;
            ...
            while (source.hasRemaining()) {
                ...
                if ((ch & 0x80) == 0) {
                    if (target.hasRemaining()) {
                        ...
                        if (cdl!=null)
                        	cdl.decoded(new byte[]{b}, (char)ch);
                    } else {
                        return CoderResult.OVERFLOW;
                    }
                } else {
