                ...
                if (target.hasRemaining()) {
                    ...
                    if (mode == UCNV_TILDE) {
                        ...
                        case UCNV_TILDE:
                            ...
                            if (cdl!=null)
                            	cdl.decoded(b, (char) mySourceChar);
                            continue;
                        ...
                        if (toUnicodeStatus == 0) {
                            ...
                            if (leadIsOk && trailIsOk) {
                                ...
                                targetUniChar = gbDecoder.simpleGetNextUChar(ByteBuffer.wrap(tempBuf), super.isFallbackUsed(), cdl);
                    ...
                    if (targetUniChar < 0xfffe) {
                        ...
                        if (cdl!=null)
                        	cdl.decoded(b, (char) targetUniChar);
