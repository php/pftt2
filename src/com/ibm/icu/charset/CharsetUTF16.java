...
class CharsetUTF16 extends CharsetICU {
    ...
    class CharsetDecoderUTF16 extends CharsetDecoderICU {
        ...
        protected CoderResult decodeLoop(ByteBuffer source, CharBuffer target, IntBuffer offsets, boolean flush, CharsetDecoderListener cdl) {
            ...
            if (!isBOMReadYet) {
                while (true) {
                    ...
                    toUBytesArray[toULength++] = byte_b;
                    if (cdl!=null)
                    	cdl.push(byte_b);
            ...
            if (toUnicodeStatus != 0) {
                CoderResult cr = decodeTrail(source, target, offsets, (char) toUnicodeStatus, cdl);
                if (cr != null)
                    return cr;
            }
            ...
            while (true) {
                ...
                if (!UTF16.isSurrogate(char16)) {
                    ...
                    CoderResult cr = decodeTrail(source, target, offsets, char16, cdl);
                    if (cr != null)
                        return cr;
                }
            }
        ...
        private final CoderResult decodeTrail(ByteBuffer source, CharBuffer target, IntBuffer offsets, char lead, CharsetDecoderListener cdl) {
