                ...
                if (target.hasRemaining()) {
                    ...
                    if (currentState == COMPOUND_TEXT_SINGLE_0) {
                        while (source.hasRemaining()) {
                            ...
                            if (target.hasRemaining()) {
                            	byte b = source.get();
                                target.put((char)(UConverterConstants.UNSIGNED_BYTE_MASK&b));
                                if (cdl!=null)
                                	cdl.decoded(b, (char)(UConverterConstants.UNSIGNED_BYTE_MASK&b));
                            }
                        }
                        ...
                        err = decoder.decodeLoop(source, target, offsets, true, cdl);
