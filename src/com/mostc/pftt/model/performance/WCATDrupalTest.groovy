...
/** WCAT based performance testing.
 * 
 * Based on AutoCAT (Powershell)
 * 
 * @see https://github.com/OSTC/php-perf
 *
 */

class WCATDrupalTest extends WCATPerformanceTest {
