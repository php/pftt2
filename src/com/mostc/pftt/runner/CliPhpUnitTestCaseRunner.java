...
public class CliPhpUnitTestCaseRunner extends AbstractPhpUnitTestCaseRunner {
	...
	public CliPhpUnitTestCaseRunner(Map<String, String> globals, Map<String, String> env, ConsoleManager cm, AHost host, ScenarioSet scenario_set, PhpBuild build, PhpUnitTestCase test_case, String my_temp_dir, Map<String, String> constants, String include_path, String[] include_files) {
