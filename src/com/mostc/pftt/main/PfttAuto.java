...
public class PfttAuto {
	static final BuildSpec[] BUILD_SPECS = new BuildSpec[] {
			new BuildSpec(EBuildBranch.PHP_7_4, EBuildType.TS, ECPUArch.X64),
			new BuildSpec(EBuildBranch.PHP_7_4, EBuildType.NTS, ECPUArch.X64),
			new BuildSpec(EBuildBranch.PHP_7_4, EBuildType.TS, ECPUArch.X86),
			new BuildSpec(EBuildBranch.PHP_7_4, EBuildType.NTS, ECPUArch.X86),
