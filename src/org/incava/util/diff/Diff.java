...
public class Diff<Type>
{
    ...
    public Diff(List<Type> a, List<Type> b, Comparator<Type> comp)
    {
        ...
        /*diff_form = new DiffForm(a, b);
        JFrame jf = new JFrame();
        jf.setContentPane(diff_form);
        jf.pack();
        jf.setVisible(true);*/
    }
    
    /*DiffForm diff_form;
    class DiffForm extends JPanel {
    	
    	public DiffForm(List<Type> a, List<Type> b) {
			// TODO Auto-generated constructor stub
    		
    		JButton remove_line;
    		JButton check_line; // or return
    		
    		JTable expected, actual, diff_diff;
		}
