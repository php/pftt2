...
/**
 * Exception thrown when the POP3 server does not support
 * the command.
 *  
...
public class CommandNotSupportedException extends POP3Exception {
	...
	/**
	 * Constructs the CommandNotSupportedException.
	 * 
	 * @param response
	 */
	public CommandNotSupportedException(POP3Response response) {
		super(response);
	}
