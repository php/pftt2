...
/**
 * FilterInputStream that filters correctly
 * a multiline response from a POP3 server. 
 * 
...
public class POP3MultiLineStream extends FilterInputStream {
	...
	/**
	 * Constructs a POP3MultiLineStream
	 * 
	 * @param in the InputStream from the socket
	 * @param size 
	 */
	public POP3MultiLineStream(InputStream in, int size) {
		super(in);
