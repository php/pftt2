...
FOR %%x IN ("C:\php-sdk\PFTT\cache\util\PEAR\\pear") DO (if %%x=="%PMTPMTPMT%" GOTO :NOTINSTALLED)

REM Check PEAR global ENV, set them if they do not exist
IF "%PHP_PEAR_INSTALL_DIR%"=="" SET "PHP_PEAR_INSTALL_DIR=C:\php-sdk\PFTT\cache\util\PEAR\\pear"
IF "%PHP_PEAR_BIN_DIR%"=="" SET "PHP_PEAR_BIN_DIR=C:\php-sdk\PFTT\cache\util\PEAR\"
IF "%PHP_PEAR_PHP_BIN%"=="" SET "PHP_PEAR_PHP_BIN=C:\php-sdk\php-5.4-nts-windows-vc9-x86-r9fe8c58\php.exe"
GOTO :INSTALLED
