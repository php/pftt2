...
REM begin PFTT
set PHPBIN=%TEST_PHP_EXECUTABLE%
echo %PHPBIN%
REM end PFTT
...
:RUN
REM begin PFTT
REM .. => load symfony components from joomla-platform
"%PHPBIN%" -d "include_path=.;C:\php-sdk\PFTT\current\cache\working\symfony-standard\vendor\symfony\symfony\src;C:\php-sdk\PFTT\current\cache\util\PEAR\pear;.." "C:\php-sdk\PFTT\current\cache\util\PEAR\\phpunit" %*
REM end PFTT
